/******************************************************************************
* File Name:   platform_audio_effects.h
*
* Description: platform audio effects interface
*
* Related Document:
*
*******************************************************************************
...
typedef struct
{
    ...
    wiced_result_t (*audio_effect_ioctl)    (int32_t effect_id, platform_audio_effect_ioctl_t cmd, platform_audio_effect_ioctl_data_t *cmd_data);
...
/**************************************************************************************************
* Function Name: platform_audio_effect_init
***************************************************************************************************
* Summary:
*   Initialize an effect specified by the effect_type
*
* Parameters:
*   platform_audio_effect_type_t effect_type    : refer to platform_audio_effect_type_t
*   platform_audio_effect_config_t *config      : effect specific configuration,refer to platform_audio_effect_config_t
*   uint32_t *effect_id                         : returned unique positive effect_id for the initialized effect
*
* Return:
*  wiced_result_t
*
...
/**************************************************************************************************
* Function Name: platform_audio_effect_deinit
***************************************************************************************************
* Summary:
*   De-initialize an effect specified by the effect_type
*
* Parameters:
*   uint32_t effect_id  : effect id to be deinit
*
* Return:
*  wiced_result_t
*
...
/**************************************************************************************************
* Function Name: platform_audio_effect_get_effects_type
***************************************************************************************************
* Summary:
*   Get list of all effects_type supported
*
* Parameters:
*   uint32_t *num_of_effects    : total no of effects
*
* Return:
*  uint32_t *num_of_effects : pointer to list of effects type OR NULL in case of error
*
**************************************************************************************************/
int32_t *platform_audio_effect_get_effects_type(uint32_t *num_of_effects);

/**************************************************************************************************
* Function Name: platform_audio_effect_get_effects_descriptor
***************************************************************************************************
* Summary:
*   Get effects descriptor for requested type
*
* Parameters:
*   platform_audio_effect_type_t type   : effect type
*
* Return:
...
/**************************************************************************************************
* Function Name: platform_audio_effect_process
***************************************************************************************************
* Summary:
*   Get effects descriptor for requested type
*
* Parameters:
*   uint32_t effect_id      : id of the effct to process
*   const uint32_t in_size  : input buffer size in bytes
*   uint8_t *in_buf         : pointer to input buffer, if reference buf is not applicable set size as zero and buf as NULL
*   const uint32_t ref_size : reference data input buffer size in bytes
*   uint8_t *ref_buf        : reference data buffer
*   uint32_t *out_size      : output buffer size in bytes/updated with actual size after process
*   uint8_t *out_buf        : output buffer pointer
*
* Return:
*  wiced_result_t
*
**************************************************************************************************/
wiced_result_t platform_audio_effect_process(uint32_t effect_id, const uint32_t in_size,uint8_t *in_buf,
 ...
 */
/**************************************************************************************************
* Function Name: platform_audio_effect_ioctl
***************************************************************************************************
* Summary:
*   Send an ioctl command to the audio effects.
*
* Parameters:
*   uint32_t effect_id                              : id of the effct to process.
*   platform_audio_effect_ioctl_t cmd               : ioctl command (platform_audio_effect_ioctl_t).
*   platform_audio_effect_ioctl_data_t *cmd_data    : data associated to ioctl command (platform_audio_effect_ioctl_data_t).
*
* Return:
*  wiced_result_t
*
