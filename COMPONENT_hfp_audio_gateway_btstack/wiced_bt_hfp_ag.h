...
/** Callback for events */
typedef void (*hfp_ag_hci_send_ag_event_cback_t)(uint16_t evt, uint16_t handle, hfp_ag_event_t *p_data);
 ...
 */
extern void hfp_ag_startup( hfp_ag_session_cb_t *p_scb, uint8_t num_scb, uint32_t features, hfp_ag_hci_send_ag_event_cback_t p_app_cback );
 ...
 */
extern void hfp_ag_connect(wiced_bt_device_address_t bd_addr);
...
extern void hfp_ag_send_BVRA_to_hf (hfp_ag_session_cb_t *p_scb, wiced_bool_t b_is_active);
extern void hfp_ag_send_RING_to_hf (hfp_ag_session_cb_t *p_scb);
extern uint8_t hfp_ag_send_VGM_to_hf (hfp_ag_session_cb_t *p_scb, int16_t gain);
extern uint8_t hfp_ag_send_VGS_to_hf(hfp_ag_session_cb_t *p_scb, int16_t gain);
