...
**
*******************************************************************************/
static void _send_error_to_hf (hfp_ag_session_cb_t *p_scb, int16_t errcode)
{
...
**
*******************************************************************************/
static void _handle_command_from_hf (hfp_ag_session_cb_t *p_scb, uint16_t cmd, uint8_t arg_type, char *p_arg, int16_t int_arg)
{
...
**
*******************************************************************************/
void hfp_ag_send_BVRA_to_hf(hfp_ag_session_cb_t *p_scb, wiced_bool_t b_is_active)
{
...
uint8_t hfp_ag_send_VGM_to_hf (hfp_ag_session_cb_t *p_scb, int16_t gain)
{
    return _send_result_to_hf (p_scb, BTA_AG_RES_VGM, NULL, gain);
}

uint8_t hfp_ag_send_VGS_to_hf (hfp_ag_session_cb_t *p_scb, int16_t gain)
{
