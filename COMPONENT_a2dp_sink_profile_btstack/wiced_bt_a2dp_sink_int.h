...
typedef void (*wiced_bt_a2sp_sink_nsm_act_t)(uint16_t avdt_event, wiced_bt_a2dp_sink_data_t *p_data);
...
extern void wiced_bt_a2dp_sink_hdl_event(uint8_t event,wiced_bt_avdt_evt_hdr_t *p_msg);
...
extern void wiced_bt_a2dp_sink_data_cback(uint8_t handle, uint16_t seq, uint32_t time_stamp, uint8_t m_pt,
