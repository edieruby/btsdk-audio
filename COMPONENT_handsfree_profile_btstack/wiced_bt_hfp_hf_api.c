...
{
#if 1
    wiced_bt_hfp_hf_connect_fail_t data;
    data.hf_evt = WICED_BT_HFP_HF_API_DEINIT_EVT;

    GKI_send_msg(WICED_BT_HFP_HF_TASK_ID, WICED_BT_HFP_HF_TASK_MBOX, &data);
#else
	wiced_bt_hfp_hf_state_evt_t   evt= WICED_BT_HFP_HF_API_DEINIT_EVT;

    GKI_send_msg(WICED_BT_HFP_HF_TASK_ID, WICED_BT_HFP_HF_TASK_MBOX, (wiced_bt_hfp_hf_data_t *)&evt);
#endif
