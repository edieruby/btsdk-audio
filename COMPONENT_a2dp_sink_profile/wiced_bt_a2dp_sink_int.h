...
#if WICED_BT_A2DP_SINK_DEBUG == TRUE
#define WICED_BTA2DP_TRACE   WICED_BT_TRACE
#else
#define WICED_BTA2DP_TRACE(...)
#endif

#define WICED_BTA2DP_SINK_ERROR     WICED_BT_TRACE

/* Set flag to TRUE to enable Lite Host decoding */
#ifndef WICED_BT_A2DP_SINK_USE_LITEHOST
#define WICED_BT_A2DP_SINK_USE_LITEHOST TRUE
#endif
...
#ifndef WICED_BT_A2DP_SINK_AVDT_SIG_CH_MTU
#define WICED_BT_A2DP_SINK_AVDT_SIG_CH_MTU              672
#endif
...
typedef enum
{
    ...
    WICED_BT_A2DP_SINK_API_START_RESP_EVT,
    WICED_BT_A2DP_SINK_API_SUSPEND_EVT,
    WICED_BT_A2DP_SINK_API_DELAY_EVT,
    ...
    WICED_BT_A2DP_SINK_STR_START_IND_EVT,
    WICED_BT_A2DP_SINK_STR_START_CFM_EVT,
...
typedef struct
{
    ...
    uint16_t                    codec_id;       /* codec id for codec_type=WICED_BT_A2DP_CODEC_VENDOR_SPECIFIC */
...
typedef struct
{
    ...
    uint8_t                          peer_sep_idx;   /* peer configured sep id */
...
extern void wiced_bt_a2dp_sink_hdl_event(BT_HDR *p_msg);
...
extern void wiced_bt_a2dp_sink_do_start(wiced_bt_a2dp_sink_ccb_t *p_ccb,
    wiced_bt_a2dp_sink_data_t *p_data);
extern void wiced_bt_a2dp_sink_send_start_resp( wiced_bt_a2dp_sink_ccb_t *p_ccb,
    wiced_bt_a2dp_sink_data_t *p_data );
extern void wiced_bt_a2dp_sink_str_stopped(wiced_bt_a2dp_sink_ccb_t *p_ccb,
    wiced_bt_a2dp_sink_data_t *p_data);
extern void wiced_bt_a2dp_sink_start_ind(wiced_bt_a2dp_sink_ccb_t *p_ccb,
    wiced_bt_a2dp_sink_data_t *p_data);
...
extern void wiced_bt_a2dp_sink_sig_closed_cleanup(wiced_bt_a2dp_sink_ccb_t *p_ccb,
    wiced_bt_a2dp_sink_data_t *p_data);
extern void wiced_bt_a2dp_sink_delay_send(wiced_bt_a2dp_sink_ccb_t *p_ccb,
    wiced_bt_a2dp_sink_data_t *p_data);
...
extern void wiced_bt_a2dp_sink_set_route_codec_config( uint32_t audio_route, wiced_bt_a2dp_codec_info_t *codec_config, uint16_t handle, uint16_t cp_type, wiced_bool_t is_master );
extern void wiced_bt_a2dp_sink_set_handle( uint16_t handle );
extern wiced_result_t wiced_bt_a2dp_sink_streaming_configure_route( uint16_t handle );
wiced_result_t wiced_bt_a2dp_sink_streaming_start(uint16_t handle);
extern wiced_result_t wiced_bt_a2dp_sink_streaming_stop( uint16_t handle );
extern void wiced_bt_a2dp_sink_stream_close( uint16_t handle );
extern wiced_result_t wiced_bt_a2dp_sink_route_config_lrac_switch_get(void *p_opaque,
        uint16_t *p_sync_data_len);
extern wiced_result_t wiced_bt_a2dp_sink_route_config_lrac_switch_set(void *p_opaque,
